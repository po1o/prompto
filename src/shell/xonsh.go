...
func (f Features) Xonsh() Code {
	...
	case PromptMark, RPrompt, PoshGit, Azure, LineError, Jobs, Tooltips, Transient, CursorPositioning, FTCSMarks, Async, Daemon, VimMode, VimCursorBlink, VimCursorShape:
		fallthrough
	default:
		return ""
	}
