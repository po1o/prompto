#
# Module manifest for module 'prompto'
#
# Generated by: Jan
#
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('git', 'agnoster', 'theme', 'zsh', 'prompto-git', 'prompt', 'paradox')

        # A URL to the license for this module.
        LicenseUri = 'https://github.com/po1o/prompto2/blob/master/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/po1o/prompto2'
