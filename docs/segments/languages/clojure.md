---
title: Clojure
description: Display the currently active Clojure version.
---
...
- `fetch_version`
  - Type: `boolean`
  - Default: `true`
  - Description: fetch the clojure version
- `cache_duration`
  - Type: `string`
  - Default: `none`
...
- `extensions`
  - Type: `[]string`
  - Default: `project.clj, deps.edn, build.boot, bb.edn, *.clj, *.cljc, *.cljs`
