...
| `vim`                       | `Vim`            |         | vim mode configuration including cursor shape and blink behavior                                                                                                                                                                                                             |
...
| Name            | Type      | Default | Description                                                                 |
| --------------- | --------- | ------- | --------------------------------------------------------------------------- |
| `enabled`       | `boolean` | `false` | enable vim mode detection                                                   |
| `cursor_shape`  | `boolean` | `false` | enable cursor shape changes for vim mode                                   |
| `cursor_blink`  | `boolean` | `false` | enable cursor blinking for vim mode (implies cursor shape handling)         |
