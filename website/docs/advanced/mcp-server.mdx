...
## What is the Prompto MCP Server?

The Prompto MCP (Model Context Protocol) Server is a validation service that allows you to validate your prompto
...
- **Standards-based**: Uses the official prompto JSON schema
...
Then ask your AI assistant to validate your prompto configuration.
...
curl -X POST https://prompto.dev/api/mcp \
  ...
  -d '{
    ...
    "params": {
      ...
      "arguments": {
        "content": "{\"$schema\":\"https://raw.githubusercontent.com/JanDeDobbeleer/prompto/main/themes/schema.json\",\"version\":4,\"blocks\":[]}",
        "format": "json"
      }
    },
    "id": 1
...
Then ask Claude: "Can you validate this prompto configuration for me?" and paste your config.
...
The MCP server is open source and part of the prompto repository:
...
The validator uses the latest schema from the main branch. If you're using an older prompto version, some newer
...
[mcp]: https://github.com/po1o/prompto/blob/main/website/api/mcp
[validator]: https://github.com/po1o/prompto/blob/main/website/api/shared/validator.js
[issue]: https://github.com/po1o/prompto/issues
