...
Adding a new segment to Prompto involves several steps to ensure proper integration. This guide walks you through creating a complete segment with all necessary files and registrations.
...
```json
{
  ...
  "then": {
    ...
    "description": "https://prompto.dev/docs/segments/system/new-feature",
    "properties": {
      "options": {
        "properties": {
          "enable_new_thing": {
...
[segment-go]: https://github.com/po1o/prompto/blob/main/src/config/segment_types.go
[themes]: https://github.com/po1o/prompto/tree/main/themes
[docs]: https://github.com/po1o/prompto/tree/main/website/docs/segments
[sidebars]: https://github.com/po1o/prompto/blob/main/website/sidebars.js
[nf-icons]: https://www.nerdfonts.com/cheat-sheet
[tests]: https://github.com/po1o/prompto/blob/main/src/segments/az_test.go
