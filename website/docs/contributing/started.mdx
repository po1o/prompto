...
your repository and create a pull request in the official Prompto repository.

To clone your fork of Prompto locally, open the terminal and replace `<user>` with your GitHub username.

```powershell
git clone git@github.com:<user>/prompto.git
```
...
:::caution
Prompto needs at least go 1.26.0
:::
...
If you already have Prompto in your `PATH`, you'll need to either use that one as an output parameter, or make sure
that the `$GOPATH/bin/` folder precedes the Prompto binary in your `PATH`.

```powershell
go build -o (Get-Command prompto.exe).Source
```
...
[gh-pr]: https://github.com/po1o/prompto/pulls
[omp]: https://github.com/po1o/prompto
[gh-fork]: https://guides.github.com/activities/forking/
[code]: https://code.visualstudio.com
[delve]: https://github.com/go-delve/delve
[docusaurus]: https://docusaurus.io
[winget-configuration]: https://github.com/po1o/prompto/blob/main/.config/configuration.winget
