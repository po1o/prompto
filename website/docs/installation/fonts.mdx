...
Prompto was designed to use [Nerd Fonts][nerdfonts]. Nerd Fonts are popular fonts that are patched to include icons.
To see the icons displayed in Prompto, **install** a [Nerd Font][nerdfonts], and **configure** your terminal to use it.
...
<TabItem value="prompto">

Prompto has a CLI to help you select and install a [Nerd Font][nerdfonts]:
...
By default, Prompto installs the `.ttf` version of the font in case multiple versions are available.
:::
