...
You can install Prompto via [MacPorts] which is maintained by the [community][ports page].

```bash
sudo port selfupdate
sudo port install prompto
```

Prompto will be installed at `/opt/local/bin/prompto`.

Updating is done via:

```bash
sudo port selfupdate
sudo port upgrade prompto
```

More details on the [ports page] for Prompto.
...
[ports page]: https://ports.macports.org/port/prompto/
[outdated-bash]: https://github.com/po1o/prompto/discussions/3429
